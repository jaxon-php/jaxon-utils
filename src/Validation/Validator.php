...
class Validator
{
     ...
     * @return bool
     */
    public function validateFunction(string $sName)
    {
        $this->sErrorMessage = '';
     ...
     * @return bool
     */
    public function validateEvent(string $sName)
    {
        $this->sErrorMessage = '';
        return (preg_match('/^[a-zA-Z_\x7f-\xff][a-zA-Z0-9_\x7f-\xff]*$/', $sName) > 0);
    }
     ...
     * @return bool
     */
    public function validateClass(string $sName)
    {
        $this->sErrorMessage = '';
     ...
     * @return bool
     */
    public function validateMethod(string $sName)
    {
        $this->sErrorMessage = '';
        // return (preg_match('/^[a-zA-Z_\x7f-\xff][a-zA-Z0-9_\x7f-\xff]*$/', $sName) > 0);
     ...
     * @return bool
     */
    private function validateFileProperty(string $sName, string $sValue, string $sProperty, string $sField)
    {
     ...
     *
     * @param string $sName The uploaded file variable name
     * @param int $iFileSize The uploaded file size
     * @param string $sProperty The property name in config options
     *
     * @return bool
     */
    private function validateFileSize(string $sName, int $iFileSize, string $sProperty)
    {
     ...
     * @return bool
     */
    public function validateUploadedFile(string $sName, array $aUploadedFile)
    {
        $this->sErrorMessage = '';
